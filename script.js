document.addEventListener('DOMContentLoaded', () => {
    ...
    /**
     * Creates and appends a new window element to the desktop.
     * @param {string} title - The title of the window.
     * @param {string} contentHTML - The HTML content for the window body.
    ...
    /**
     * Adds resize functionality to a window element.
     * @param {HTMLElement} windowEl - The window element to make resizable.
     */
    ...
    /**
     * Brings a clicked window to the foreground by updating its z-index.
     * @param {HTMLElement} windowEl - The window element to make active.
     */
    ...
    /**
     * Sets up event listeners for the close, minimize, and maximize buttons.
